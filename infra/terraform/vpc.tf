...
resource "aws_subnet" "data" {
  ...
  tags = { Name = "${local.name_prefix}-data-${var.availability_zones[count.index]}" }
}
...
resource "aws_security_group" "api" {
  ...
  description = "dariyah-core API tasks"
  vpc_id      = aws_vpc.main.id
...
resource "aws_security_group" "rds" {
  ...
  description = "RDS PostgreSQL — only API + worker access"
  vpc_id      = aws_vpc.main.id
...
resource "aws_security_group" "redis" {
  ...
  description = "ElastiCache Redis — only API + worker access"
  vpc_id      = aws_vpc.main.id
